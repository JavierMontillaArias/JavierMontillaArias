...
<p align="center">
  <b>Junior Full-Stack Developer</b> · Python &amp; JavaScript · building end-to-end web &amp; mobile apps
</p>
<p align="center">
...
- Finishing my Higher Vocational Diploma in **Cross-Platform Application Development (DAM)**.
- I build **end-to-end applications**: REST APIs (FastAPI, Spring Boot), web frontends (React + TypeScript) and native Android apps (Kotlin).
- Comfortable with **relational databases &amp; ORMs** (PostgreSQL, MySQL, SQLAlchemy, JPA/Hibernate) and **JWT** authentication.
- Into **open source, backend/APIs, R&amp;D and AI/ML**.
...
> I also built a full-stack web platform (**Spring Boot + React**) during a software-development internship — private repository.
